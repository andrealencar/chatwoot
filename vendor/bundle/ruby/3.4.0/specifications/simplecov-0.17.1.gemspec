...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<json>.freeze, [">= 1.8".freeze, "< 3".freeze])
  s.add_runtime_dependency(%q<simplecov-html>.freeze, ["~> 0.10.0".freeze])
  ...
  s.add_development_dependency(%q<phantomjs>.freeze, [">= 0".freeze])
